...
public final class FullValueDescription implements org.omg.CORBA.portable.IDLEntity {
    ...
    public FullValueDescription(String _name, String _id, boolean _is_abstract, boolean _is_custom, byte _flags, String _defined_in, String _version,
                                org.omg.CORBA.OperationDescription[] _operations, org.omg.CORBA.AttributeDescription[] _attributes,
                                org.omg.CORBA.ValueMember[] _members, org.omg.CORBA.Initializer[] _initializers, String[] _supported_interfaces,
                                String[] _abstract_base_values, boolean _has_safe_base, String _base_value, org.omg.CORBA.TypeCode _type) {
        name = _name;
        id = _id;
