...
public final class FullInterfaceDescription implements org.omg.CORBA.portable.IDLEntity {
    ...
    public FullInterfaceDescription(String _name, String _id, String _defined_in, String _version, boolean _is_abstract,
                                    org.omg.CORBA.OperationDescription[] _operations, org.omg.CORBA.AttributeDescription[] _attributes,
                                    String[] _base_interfaces, org.omg.CORBA.TypeCode _type) {
        name = _name;
        id = _id;
